...
4. [무료 도구 전체 목록 (RadiConsole™ .NET 8 기준)](#4-무료-도구-전체-목록-radiconsoletm-net-8-기준)
...
본 가이드는 HnX-R1 RadiConsole™의 공인기관(KTL 등) 사이버보안 시험 의뢰 전에, 내부에서 **무료 또는 최소 비용**으로 자체 사전평가를 수행하여 시험 불합격 리스크를 최소화하는 것을 목적으로 한다.

**핵심 원칙**: 공인기관 시험 전에 자체적으로 발견하고 수정할 수 있는 것은 모두 미리 처리하여 **1회 시험 통과율을 극대화**한다.

> **중요 통계**: 공인기관 시험에서 불합격 사유 중 자체 사전평가로 방지할 수 있는 비율은 **70~80%**에 해당한다. 즉, 체계적인 자체 사전평가만으로도 대부분의 불합격 요인을 사전에 제거할 수 있다.

### 1.2 적용 범위

- **제품**: HnX-R1 RadiConsole™ (X-ray 촬영 콘솔 소프트웨어)
...
IEC 81001-5-1 Clause 5.1을 기반으로 RadiConsole™의 보안 요구사항을 수립한다.
...
- RadiConsole™의 관리 웹 인터페이스(있는 경우) 스캔
...
## 4. 무료 도구 전체 목록 (RadiConsole™ .NET 8 기준)
...
|------|----------------------|-------------------|
| 1차 시험 통과율 | 낮음 (불합격 사유 70~80% 잔존) | **대폭 향상** (주요 불합격 사유 사전 제거) |
| 재시험 횟수 | 1~3회 추가 가능성 | 최소화 |
| 추가 시험 비용 | 1회당 수천만 원 발생 | 절감 |
| 일정 지연 | 수개월 지연 위험 | 출시 일정 준수 가능 |
...
| 항목 | 비용 |
|------|------|
| 자체 사전평가 비용 | **무료** (도구 모두 오픈소스/무료) |
| 절감 가능 재시험 비용 | 1회 시험 비용 × 재시험 횟수 |
| 일정 절감 가치 | 시장 출시 지연 방지에 따른 기회비용 |
...
*본 문서는 HnX-R1 RadiConsole™ 프로젝트의 내부 사용을 위해 작성되었습니다.*  
