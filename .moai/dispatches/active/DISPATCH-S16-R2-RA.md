...
|---------|------|------|--------|----------|-----------|------|
| T1 | DOC-042 CMP v2.0 승격 | COMPLETED | RA | P1 | 2026-04-22T15:10:00+09:00 | 이미 v2.5 Approved 상태 |
| T2 | SPEC-GOVERNANCE-001 착수 | COMPLETED | RA | P2 | 2026-04-22T15:20:00+09:00 | progress.md 생성 + 수용 기준 6개 분석 |
...
- [HARD] ScheduleWakeup(1080초) 유지 — 작업 완료 push 직후 재설정 (Phase 4, _CURRENT.md §팀별설정)
