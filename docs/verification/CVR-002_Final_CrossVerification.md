...
| # | 문서 ID | 문서명 | 파일명 | 크기 | 상태 |
|---|---------|--------|--------|------|------|
| 1 | WBS-001 | 작업 분해 구조 (WBS) v4.0 | WBS-001_WBS_v4.0.md | 87.3 KB | ✅ |
| 2 | DMP-001 | 개발 관리 계획서 (DMP) v2.0 | DMP-001_DMP_v2.0.md | 63.9 KB | ✅ |
| 3 | DOC-001 | 시장 요구사항 정의서 (MRD) v2.0 | DOC-001_MRD_v2.0.md | 75.9 KB | ✅ |
| 4 | DOC-002 | 제품 요구사항 정의서 (PRD) v3.0 | DOC-002_PRD_v3.0.md | 111.6 KB | ✅ |
...
| 문서 | 버전 | 비고 |
|------|------|------|
| MRD | v2.0 | PRD 개정 시 동시 개정 |
| PRD | v3.0 | PR-xxx 중간 계층 추가 반영 |
| WBS | v4.0 | 전체 문서 체계 반영 |
| DMP | v2.0 | 전체 개발 계획 갱신 |
| 기타 문서 | v1.0 | 초판 |
