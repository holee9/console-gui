...
| [TBD - 개발 완료 후 작성] | .NET 8.0 Runtime (SBOM-002) | 8.0.x | [TBD] | [TBD] | [TBD — TM-T-004 업데이트 변조 위협과 연계 검토 필요 (DOC-017 §5.3 참조)] | [TBD] | [TBD] | [TBD] |
...
| 3 (보통) | SBOM-002 | .NET 8.0 Runtime | 8.0.x | TM-T-004 (SW 업데이트 변조) — 런타임 전체 영향 | .NET 8.0 LTS(2026-11 EOL) 정기 패치 모니터링 |
...
> **참고**: .NET 8.0 Runtime (SBOM-002)은 LTS(Long Term Support, 2026년 11월 EOL)이며, 정기 보안 패치를 모니터링한다.
...
| TM-T-004 | SW 업데이트 바이너리 변조 | .NET 8.0 Runtime (SBOM-002) | High — 코드 서명 검증 로직 연계 |
...
| TM-E-003 | DLL Injection | .NET 8.0 (SBOM-002) | High — DLL 경로 고정 및 서명 검증 연계 |
