...
- 개발자 2: Team Design(XAML 코드화) + Team A 보조(인프라 단순 작업)
- Design Team은 코더가 없으므로 C# 기능구현은 SW팀장(Coordinator)과 개발자 1(Team B)이 분담
...
#### Team A — 인프라 및 기초 계층 (SW 개발팀장 겸임 + 개발자 2 보조)
...
#### Team Design — 순수 UI 디자인 (개발자 2 전담, 코더 없음)
...
| 활동 | Team A (팀장+Dev2) | Team B (Dev1) | Design (Dev2) | Coordinator (팀장) | QA | RA |
|------|--------|--------|--------|------------|----|----|
...
**겸임 참고:** Team A와 Coordinator는 SW 개발팀장 1명이 겸임. Design과 Team A 보조는 개발자 2가 겸임.
