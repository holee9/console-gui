...
본 계획서는 HnVue Console SW (RadiConsole™)의 **시판 후(Post-Market)** 단계에서 신규 취약점 발견 시:
...
```
제목: [보안 알림] HnVue Console SW (RadiConsole™) v[패치 버전] 보안 업데이트 안내

안녕하십니까, HnVue 기술 지원팀입니다.

HnVue Console SW (RadiConsole™)의 보안 취약점 패치를 포함한 v[버전] 업데이트를 배포합니다.
