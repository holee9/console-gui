...
| **적용 팀** | SW 개발팀, QA팀, 시스템 엔지니어링팀, 규제팀 |
...
| **서명 (Approval)** | 개발팀장, QA팀장, (해당 시) 규제팀장 서명 |
...
| 검토 단계 | 검토 내용 | 참가자 |
|----------|----------|--------|
| **DR#1** 요구사항 검토 | PRD/SRS 완전성, 추적성, 위험 커버리지 | PM, QA, 규제팀, 임상 담당 |
...
| **DR#5** V&V 검토 | 테스트 결과, 결함 현황, 추적성 확인 | 개발팀, QA, 규제팀 |
...
| 8 | 요구사항 검토 회의에 PM, QA, 규제팀, 임상 담당자가 참석했는가? | ☐ Pass ☐ Fail | |
