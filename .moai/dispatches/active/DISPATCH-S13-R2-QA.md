...
|---------|------|------|--------|----------|-----------|------|
| T1 | 빌드/테스트/커버리지 게이트 | IN_PROGRESS | QA | P0 | 2026-04-20T00:00:00+09:00 | 전체 솔루션 |
| T2 | 커버리지 리포트 | NOT_STARTED | QA | P1 | _ | 모듈별 상세 |
| T3 | 아키텍처 테스트 | NOT_STARTED | QA | P2 | _ | NetArchTest |
