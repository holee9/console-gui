...
|---------|------|------|--------|----------|-----------|------|
| T1 | 빌드/테스트 게이트 | IN_PROGRESS | QA | P0 | 2026-04-20T16:36:00+09:00 | 빌드/테스트 시작 |
| T2 | 커버리지 리포트 | NOT_STARTED | QA | P1 | _ | ACTIVE (CC 전환) |
| T3 | 아키텍처 테스트 | NOT_STARTED | QA | P2 | _ | ACTIVE (CC 전환) |
