...
|---------|------|------|--------|----------|-----------|------|
| T1 | 전체 빌드 + 테스트 재측정 | COMPLETED | QA | P1 | 2026-04-22T14:30:00+09:00 | 빌드 0에러, 515/515 통과 (6.12분) |
...
| T4 | 릴리즈 준비도 스냅샷 | BLOCKED | QA | P3 | 2026-04-22T14:30:00+09:00 | PowerShell 실행 환경 없음 (pwsh/powershell.exe 찾을 수 없음) |
