...
본 지침서는 HnVue Console SW의 제품개발 전 단계에 걸쳐 IEC 62304 Class B 소프트웨어 개발 표준을 준수하는 **체계적이고 반복 가능한(repeatable)** 개발 프로세스를 정의한다.
...
HnVue Console SW는 **IEC 62304 Class B**로 분류된다. 분류 근거는 다음과 같다:
...
*본 문서는 HnVue Console SW 개발팀의 공식 지침서입니다.*  
