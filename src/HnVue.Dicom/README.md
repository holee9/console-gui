...
| 타입 | 종류 | 설명 |
|------|------|------|
| `DicomService` | `sealed partial class` | `IDicomService` 구현체. C-STORE / C-FIND / Print / Storage Commitment 통합 서비스 |
...
| `DicomFindScu` | `sealed class` | Modality Worklist C-FIND SCU |
