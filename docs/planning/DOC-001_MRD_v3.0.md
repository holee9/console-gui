...
| 버전 | 날짜 | 개정자 | 개정 내용 |
|------|------|--------|---------|
| **[NEW v4.0]** v4.0 | **[NEW v4.0]** 2026-04-06 | **[NEW v4.0]** 전략마케팅본부 | **[NEW v4.0]** 글로벌 36사 딥리서치 기반 신규 MR 20건(MR-073~092) 추가, 신규 벤더 16사 추가, 2024-2026 기술 트렌드 및 규제 변화 반영, 구현 모듈 교차검증 결과 반영 |
...
### **[NEW v4.0]** 3.1b v4.0 추가 발견 벤더 (16사)

> **[NEW v4.0]**: 2026년 4월 딥리서치를 통해 식별된 추가 벤더. 기존 20사 + 신규 16사 = 총 36사 경쟁 환경.

| 업체 | 제품명 | 국가 | 핵심 특징 | 비고 |
|------|--------|------|-----------|------|
| Shimadzu | RADspeed Pro / MobileDaRt | 일본 | VISION SUPPORT 카메라, Smart Tube 인식 | 글로벌 Top5 |
| GE HealthCare | Helix 2.2 / Critical Care Suite 2.1 | 미국 | 온디바이스 AI 기흉 감지 (AUC 0.96), FDA AI 96개 | 글로벌 1위 |
| Control-X Medical | Perform-X / RadiologiX | 헝가리 | OEM 중급 시장 | -- |
| Arcoma | Canon CXDI NE 기반 | 스웨덴 | Canon 영상 SW 통합 | -- |
| Medlink Imaging | SDR+ | 미국 | 10" 터치, 다국어, Vieworks 자회사 | -- |
| DK Medical | Innovision | 한국 | RSNA 2025 신제품, 국내 신흥 경쟁사 | -- |
| Idetec | ATLAS DR | 프랑스 | 레트로핏 전문 | -- |
| BMI Biomedical | 자체 Acquisition SW | 이탈리아 | DICOM 풀 커넥티비티 | -- |
| Innomed | TOP-X DR | 헝가리 | 자체 imaging SW + PACS | -- |
| Allengers | Digital DR Console | 인도 | 인도 최대 X-ray 제조사 | -- |
| Simad | DICOM Dose Report 콘솔 | 이탈리아 | 자동 RDSR 생성 특화 | -- |
| E-COM | DROC | 중국 | 벤더 중립, 60+ 국가, 저가 파괴 모델 | -- |
| Whale Imaging | G-Arm X-Pano | 중국 | 파노라마 이미징 전문 | -- |
| EOS Imaging | EOS Console | 프랑스 | 2D/3D 정형외과 전문 | -- |
| PerLove | Full-Spine Console | 중국 | One-shot full-view imaging | -- |
| Medicatech USA | DR Acquisition SW | 미국 | DR + PACS 통합 솔루션 | -- |
...
| **[NEW v4.0]** MR-073 | **[NEW v4.0]** 워크플로우 | **[NEW v4.0]** 자동 이미지 회전 (Auto-Rotate): 촬영된 영상을 해부학적 표준 방향으로 AI/규칙 기반 자동 회전해야 한다 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** Functional | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Usability Test | **[NEW v4.0]** HAZ-UX-001 (조작 오류) | **[NEW v4.0]** Agfa SmartRotate (91% 회전 감소); 경쟁사 다수 기본 기능 |
| **[NEW v4.0]** MR-075 | **[NEW v4.0]** 워크플로우 | **[NEW v4.0]** Barcode/QR 환자 식별: 환자 손목밴드 바코드/QR 스캔으로 워크리스트 자동 매칭하여 환자 오인을 방지해야 한다 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** Functional, Safety | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Clinical Simulation | **[NEW v4.0]** HAZ-WF-001 (환자 정보 오입력) | **[NEW v4.0]** GE Auto Protocol Assist; USB HID 표준; 환자 안전 강화 |
| **[NEW v4.0]** MR-080 | **[NEW v4.0]** 워크플로우 | **[NEW v4.0]** 디텍터 공유 (Detector Sharing): 1개 FPD를 여러 촬영실에서 공유하고 1-click으로 등록/전환할 수 있어야 한다 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** Functional | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Demonstration | **[NEW v4.0]** HAZ-HW-001 (디텍터 오선택) | **[NEW v4.0]** Siemens MAXswap; Philips SkyPlate sharing; 병원 장비 활용 최적화 |
| **[NEW v4.0]** MR-083 | **[NEW v4.0]** 워크플로우 | **[NEW v4.0]** 훈련/시뮬레이션 모드: 방사선 발생 없이 전체 촬영 워크플로우를 연습할 수 있는 교육 모드를 제공해야 한다 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** Functional, Usability | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Usability Test | **[NEW v4.0]** HAZ-UX-002 (사용 오류) | **[NEW v4.0]** DRGEM RadTrainer; 신규 방사선사 교육 지원 |
| **[NEW v4.0]** MR-091 | **[NEW v4.0]** 워크플로우 | **[NEW v4.0]** Pre-Exposure 모션 감지: 촬영 직전 환자 움직임을 센서/카메라로 감지하여 경고를 제공하고 재촬영을 방지해야 한다 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** Functional, Safety | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Clinical Simulation | **[NEW v4.0]** HAZ-DM-001 (과다 선량) | **[NEW v4.0]** Shimadzu VISION SUPPORT; Fujifilm FDR Visionary Suite; 하드웨어 의존 |
...
| **[NEW v4.0]** MR-077 | **[NEW v4.0]** 영상 품질 | **[NEW v4.0]** Dual-Energy Subtraction Imaging: 2개 에너지 레벨(고/저 kVp)로 촬영하여 연조직/골 분리 이미지를 생성해야 한다 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** Functional | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Clinical Simulation | **[NEW v4.0]** HAZ-IP-001 (진단 오류) | **[NEW v4.0]** Carestream Eclipse Dual-Energy; Shimadzu 벤치마크; 고급 진단 차별화 |
| **[NEW v4.0]** MR-081 | **[NEW v4.0]** 영상 품질 | **[NEW v4.0]** Multi-Frequency Image Processing: 단일 촬영에서 다중 주파수 대역별 최적 처리를 적용하여 일관된 영상 품질을 보장해야 한다 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** Functional, Performance | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Clinical Simulation | **[NEW v4.0]** HAZ-IP-001 (진단 오류) | **[NEW v4.0]** Carestream Eclipse Engine; 영상 품질 고도화 |
| **[NEW v4.0]** MR-084 | **[NEW v4.0]** 영상 품질 | **[NEW v4.0]** Dynamic Digital Radiography (DDR): 최대 15fps 연속 촬영으로 해부학적 운동(폐 환기, 횡격막)을 관찰할 수 있어야 한다 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** Functional | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Clinical Simulation | **[NEW v4.0]** HAZ-IP-001 (진단 오류) | **[NEW v4.0]** Konica Minolta DDR (업계 유일, FDA 승인); 니치 시장, 하드웨어 의존 |
| **[NEW v4.0]** MR-087 | **[NEW v4.0]** 영상 품질 | **[NEW v4.0]** Cobb Angle 자동 측정: 척추 측만증 각도를 알고리즘으로 자동 계산하여 측정 결과를 표시해야 한다 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** Functional | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Clinical Simulation | **[NEW v4.0]** HAZ-IP-001 (진단 오류) | **[NEW v4.0]** dicomPACS DX-R; ChiroSight; 정형외과 전문 기능 |
...
| **[NEW v4.0]** MR-074 | **[NEW v4.0]** 통합/연동 | **[NEW v4.0]** DICOM Presentation State (GSPS) 저장/로드: 영상 주석, W/L 설정을 DICOM Grayscale Softcopy Presentation State로 저장하여 PACS에서 재현 가능해야 한다 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** Interface | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** N/A | **[NEW v4.0]** HAZ-DATA (데이터 무결성) | **[NEW v4.0]** DICOM PS3.3 A.33 표준; 대형병원 판독 워크플로우 요구 |
| **[NEW v4.0]** MR-076 | **[NEW v4.0]** 통합/연동 | **[NEW v4.0]** DICOMweb (WADO-RS/STOW-RS) 지원: RESTful DICOM 웹 서비스로 클라우드 PACS와 연동할 수 있어야 한다 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** Interface | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** N/A | **[NEW v4.0]** HAZ-CS-001 (비인가 접근) | **[NEW v4.0]** Philips Image Management 15; OHIF Viewer; 클라우드 전환 대비 |
| **[NEW v4.0]** MR-079 | **[NEW v4.0]** 통합/연동 | **[NEW v4.0]** HL7v2 ADT/ORM 직접 수신: RIS 없이 HIS에서 직접 HL7v2 ADT(환자 정보)/ORM(오더) 메시지를 수신하여 워크리스트를 구성할 수 있어야 한다 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** Interface | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** N/A | **[NEW v4.0]** HAZ-WF-001 (환자 정보 오류) | **[NEW v4.0]** RIS 미보유 중소병원 현실 요구; HL7 v2.x 표준 |
| **[NEW v4.0]** MR-086 | **[NEW v4.0]** 통합/연동 | **[NEW v4.0]** Zero-Footprint Web Viewer: 설치 없이 HTML5 브라우저에서 촬영 영상을 조회할 수 있는 내장 웹 뷰어를 제공해야 한다 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** Interface, Functional | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Demonstration | **[NEW v4.0]** N/A | **[NEW v4.0]** Philips Vue PACS 15; AGFA XERO; OHIF Viewer 오픈소스 활용 가능 |
...
| **[NEW v4.0]** MR-078 | **[NEW v4.0]** 선량 관리 | **[NEW v4.0]** 선량 크립 모니터링 (Dose Creep Monitoring): 시간 경과에 따른 평균 선량의 점진적 증가 트렌드를 자동 감지하고 경고해야 한다 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** Safety, Functional | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** N/A | **[NEW v4.0]** HAZ-DM-001 (과다 선량) | **[NEW v4.0]** Qaelum DOSE; IHE REM Profile; 방사선 안전 강화 |
...
| **[NEW v4.0]** MR-082 | **[NEW v4.0]** UX/UI | **[NEW v4.0]** DICOM GSDF 디스플레이 교정: DICOM Part 14 Grayscale Standard Display Function 준수 모니터 교정 도구를 제공하여 영상 표시 품질을 보증해야 한다 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** Usability, Performance | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** N/A | **[NEW v4.0]** HAZ-IP-001 (진단 오류) | **[NEW v4.0]** Barco 벤치마크; DICOM 표준; 영상 표시 일관성 보장 |
...
| **[NEW v4.0]** MR-089 | **[NEW v4.0]** 규제 준수 | **[NEW v4.0]** EU AI Act 고위험 AI 준수: 의료기기 내 AI 모듈 도입 시 EU AI Act (Regulation 2024/1689)의 고위험 AI 기술문서, 편향성 검토, 인간 감독 요구사항을 충족해야 한다 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** Regulatory | **[NEW v4.0]** TBD | **[NEW v4.0]** Inspection | **[NEW v4.0]** N/A | **[NEW v4.0]** N/A | **[NEW v4.0]** EU AI Act 2026.08 시행; AI 기능 도입 시 필수 (Phase 3+) |
| **[NEW v4.0]** MR-090 | **[NEW v4.0]** 규제 준수 | **[NEW v4.0]** NIS2 사이버 인시던트 보고: EU NIS2 Directive 및 MDR Article 87a 기반으로 30일 이내 활성 악용 취약점 및 심각 인시던트를 규제기관에 보고하는 체계를 갖추어야 한다 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** Regulatory | **[NEW v4.0]** TBD | **[NEW v4.0]** Inspection | **[NEW v4.0]** N/A | **[NEW v4.0]** HAZ-CS-004 (취약한 컴포넌트) | **[NEW v4.0]** EU NIS2 Directive 2025-2026; EU 시장 진출 시 필수 |
...
| **[NEW v4.0]** MR-085 | **[NEW v4.0]** AI-Readiness | **[NEW v4.0]** On-Device AI CADe (Critical Finding Detection): 콘솔 SW 자체에서 AI 기반 critical finding (기흉, 기관내관 위치 이상 등)을 자동 감지하여 워크리스트 우선순위를 지정해야 한다 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** Functional | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Clinical Simulation | **[NEW v4.0]** HAZ-AI-001 (AI 오진단 보조) | **[NEW v4.0]** GE Critical Care Suite 2.1 (AUC 0.96); DRGEM RADMAX; AI 파트너십 전제 |
| **[NEW v4.0]** MR-088 | **[NEW v4.0]** 확장성 | **[NEW v4.0]** 원격 서비스/예지 정비 연동: 시스템 상태 원격 모니터링 및 IoT 센서 기반 장애 예측 알림을 외부 서비스 플랫폼과 연동할 수 있어야 한다 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** Interface, Functional | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Demonstration | **[NEW v4.0]** N/A | **[NEW v4.0]** Siemens Remote Service; Philips FutureProof20; 서비스 모델 고도화 |
| **[NEW v4.0]** MR-092 | **[NEW v4.0]** 확장성 | **[NEW v4.0]** 에너지 절감 모드 (Power Save): 비사용 시 자동 절전 모드로 전환하고 촬영 요청 시 빠르게 복귀할 수 있어야 한다 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** Functional | **[NEW v4.0]** TBD | **[NEW v4.0]** Test | **[NEW v4.0]** Demonstration | **[NEW v4.0]** N/A | **[NEW v4.0]** Green Radiology Initiative; ECR 2025 지속가능성 트렌드 |
...
### **[NEW v4.0]** v4.0 변경사항 (2026-04-06)

#### **[NEW v4.0]** 글로벌 딥리서치 기반 신규 MR 추가
- **[NEW v4.0]** **조사 범위**: 기존 20사 + 신규 16사 = 총 36사 X-Ray 콘솔 SW 벤더 조사
- **[NEW v4.0]** **교차검증**: 구현 모듈 14개 (153개 소스 파일) vs MRD v3.0 (72개 MR) 매핑 완료
- **[NEW v4.0]** **참조 문서**: `CVR-002_MRD_PRD_CrossVerification_v1.0.md`

#### **[NEW v4.0]** 신규 MR 추가 (20건: MR-073 ~ MR-092)

| **[NEW v4.0]** MR | **[NEW v4.0]** 카테고리 | **[NEW v4.0]** Tier | **[NEW v4.0]** 분류 |
|----|---------|------|------|
| **[NEW v4.0]** MR-073 | **[NEW v4.0]** 워크플로우 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-074 | **[NEW v4.0]** 통합/연동 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-075 | **[NEW v4.0]** 워크플로우 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-076 | **[NEW v4.0]** 통합/연동 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-077 | **[NEW v4.0]** 영상 품질 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-078 | **[NEW v4.0]** 선량 관리 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-079 | **[NEW v4.0]** 통합/연동 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-080 | **[NEW v4.0]** 워크플로우 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-081 | **[NEW v4.0]** 영상 품질 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-082 | **[NEW v4.0]** UX/UI | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-083 | **[NEW v4.0]** 워크플로우 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-084 | **[NEW v4.0]** 영상 품질 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-085 | **[NEW v4.0]** AI-Readiness | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-086 | **[NEW v4.0]** 통합/연동 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-087 | **[NEW v4.0]** 영상 품질 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-088 | **[NEW v4.0]** 확장성 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-089 | **[NEW v4.0]** 규제 준수 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-090 | **[NEW v4.0]** 규제 준수 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-091 | **[NEW v4.0]** 워크플로우 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-092 | **[NEW v4.0]** 확장성 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 있으면좋음 |

#### **[NEW v4.0]** Tier 분포 변경

| **[NEW v4.0]** Tier | **[NEW v4.0]** v3.0 | **[NEW v4.0]** v4.0 | **[NEW v4.0]** 변경 |
|------|------|------|------|
| **[NEW v4.0]** Tier 1 | **[NEW v4.0]** 13 | **[NEW v4.0]** 13 | **[NEW v4.0]** 변동 없음 |
| **[NEW v4.0]** Tier 2 | **[NEW v4.0]** 17 | **[NEW v4.0]** 17 | **[NEW v4.0]** 변동 없음 |
| **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 25 | **[NEW v4.0]** 35 | **[NEW v4.0]** +10 (추후업그레이드) |
| **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 13 | **[NEW v4.0]** 23 | **[NEW v4.0]** +10 (있으면좋음) |
| **[NEW v4.0]** 제외 | **[NEW v4.0]** 4 | **[NEW v4.0]** 4 | **[NEW v4.0]** 변동 없음 |
| **[NEW v4.0]** **합계** | **[NEW v4.0]** **72** | **[NEW v4.0]** **92** | **[NEW v4.0]** **+20** |

#### **[NEW v4.0]** Phase 영향도
- **[NEW v4.0]** **Phase 1 (Tier 1+2)**: 변동 없음 (30개 유지)
- **[NEW v4.0]** **Phase 2 (Tier 3)**: 25 → 35개 (+10, 인력 보강 전제)
- **[NEW v4.0]** **Phase 3+ (Tier 4)**: 13 → 23개 (+10, 장기 로드맵)
...
| **[NEW v4.0]** 카테고리 | **[NEW v4.0]** Tier 1 | **[NEW v4.0]** Tier 2 | **[NEW v4.0]** Tier 3 | **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 제외 | **[NEW v4.0]** 합계 (활성) |
|---------|:------:|:------:|:------:|:------:|:----:|:----------:|
| **[NEW v4.0]** 워크플로우 효율성 | **[NEW v4.0]** 0 | **[NEW v4.0]** 6 | **[NEW v4.0]** 11 | **[NEW v4.0]** 1 | **[NEW v4.0]** 1 | **[NEW v4.0]** **19** (18) |
| **[NEW v4.0]** 영상 품질 | **[NEW v4.0]** 0 | **[NEW v4.0]** 3 | **[NEW v4.0]** 6 | **[NEW v4.0]** 5 | **[NEW v4.0]** 0 | **[NEW v4.0]** **14** (14) |
| **[NEW v4.0]** 통합/연동성 | **[NEW v4.0]** 2 | **[NEW v4.0]** 4 | **[NEW v4.0]** 3 | **[NEW v4.0]** 3 | **[NEW v4.0]** 1 | **[NEW v4.0]** **13** (12) |
| **[NEW v4.0]** 안전성/선량 관리 | **[NEW v4.0]** 0 | **[NEW v4.0]** 1 | **[NEW v4.0]** 6 | **[NEW v4.0]** 0 | **[NEW v4.0]** 0 | **[NEW v4.0]** **7** (7) |
| **[NEW v4.0]** 사이버보안 | **[NEW v4.0]** 6 | **[NEW v4.0]** 0 | **[NEW v4.0]** 2 | **[NEW v4.0]** 0 | **[NEW v4.0]** 0 | **[NEW v4.0]** **8** (8) |
| **[NEW v4.0]** 사용성 (UX/UI) | **[NEW v4.0]** 0 | **[NEW v4.0]** 3 | **[NEW v4.0]** 6 | **[NEW v4.0]** 2 | **[NEW v4.0]** 0 | **[NEW v4.0]** **11** (11) |
| **[NEW v4.0]** 규제 준수 | **[NEW v4.0]** 5 | **[NEW v4.0]** 0 | **[NEW v4.0]** 1 | **[NEW v4.0]** 2 | **[NEW v4.0]** 0 | **[NEW v4.0]** **8** (8) |
| **[NEW v4.0]** 확장성/AI-Readiness | **[NEW v4.0]** 0 | **[NEW v4.0]** 0 | **[NEW v4.0]** 0 | **[NEW v4.0]** 8 | **[NEW v4.0]** 2 | **[NEW v4.0]** **10** (8) |
| **[NEW v4.0]** **합계** | **[NEW v4.0]** **13** | **[NEW v4.0]** **17** | **[NEW v4.0]** **35** | **[NEW v4.0]** **21** | **[NEW v4.0]** **4** | **[NEW v4.0]** **90** (86 활성) |

#### **[NEW v4.0]** v3.0 대비 v4.0 변경 요약

| **[NEW v4.0]** 항목 | **[NEW v4.0]** v3.0 | **[NEW v4.0]** v4.0 | **[NEW v4.0]** 변경 |
|------|------|------|------|
| **[NEW v4.0]** 총 MR 수 | **[NEW v4.0]** 72 (68 활성) | **[NEW v4.0]** 92 (88 활성) | **[NEW v4.0]** +20 신규 (MR-073~092) |
| **[NEW v4.0]** Tier 1 | **[NEW v4.0]** 13 | **[NEW v4.0]** 13 | **[NEW v4.0]** 변동 없음 |
| **[NEW v4.0]** Tier 2 | **[NEW v4.0]** 17 | **[NEW v4.0]** 17 | **[NEW v4.0]** 변동 없음 |
| **[NEW v4.0]** Tier 3 | **[NEW v4.0]** 25 | **[NEW v4.0]** 35 | **[NEW v4.0]** +10 (추후업그레이드) |
| **[NEW v4.0]** Tier 4 | **[NEW v4.0]** 13 | **[NEW v4.0]** 23 | **[NEW v4.0]** +10 (있으면좋음) |
| **[NEW v4.0]** 제외 | **[NEW v4.0]** 4 | **[NEW v4.0]** 4 | **[NEW v4.0]** 변동 없음 |
| **[NEW v4.0]** 경쟁사 분석 벤더 수 | **[NEW v4.0]** 20사 | **[NEW v4.0]** 36사 | **[NEW v4.0]** +16 신규 벤더 |
...
### **[NEW v4.0]** 부록 F: v4.0 신규 항목 출처 및 근거

> **[NEW v4.0]**: 2026년 4월 글로벌 36사 딥리서치 및 구현 모듈 교차검증(CVR-002) 기반으로 추가된 항목.

| **[NEW v4.0]** MR ID | **[NEW v4.0]** 출처/근거 | **[NEW v4.0]** 참조 벤더 | **[NEW v4.0]** 분류 |
|-------|----------|----------|------|
| **[NEW v4.0]** MR-073 | **[NEW v4.0]** Agfa SmartRotate (91% rotation 감소), RSNA 2024 | **[NEW v4.0]** Agfa, Fujifilm, Siemens | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-074 | **[NEW v4.0]** DICOM PS3.3 A.33 GSPS 표준 | **[NEW v4.0]** DICOM 표준, 대형병원 요구 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-075 | **[NEW v4.0]** GE Auto Protocol Assist, USB HID 표준 | **[NEW v4.0]** GE, 범용 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-076 | **[NEW v4.0]** Philips Image Management 15, OHIF Viewer | **[NEW v4.0]** Philips, OHIF | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-077 | **[NEW v4.0]** Carestream Eclipse Dual-Energy, Shimadzu | **[NEW v4.0]** Carestream, Shimadzu | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-078 | **[NEW v4.0]** Qaelum DOSE, IHE REM Profile | **[NEW v4.0]** Qaelum | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-079 | **[NEW v4.0]** 중소병원 RIS 미보유 현실, HL7 v2.x 표준 | **[NEW v4.0]** 범용 | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-080 | **[NEW v4.0]** Siemens MAXswap, Philips SkyPlate sharing | **[NEW v4.0]** Siemens, Philips | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-081 | **[NEW v4.0]** Carestream Eclipse Engine multi-frequency | **[NEW v4.0]** Carestream | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-082 | **[NEW v4.0]** DICOM Part 14 GSDF, Barco | **[NEW v4.0]** DICOM 표준, Barco | **[NEW v4.0]** 추후업그레이드 |
| **[NEW v4.0]** MR-083 | **[NEW v4.0]** DRGEM RadTrainer | **[NEW v4.0]** DRGEM | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-084 | **[NEW v4.0]** Konica Minolta DDR (업계 유일, FDA 승인) | **[NEW v4.0]** Konica Minolta | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-085 | **[NEW v4.0]** GE Critical Care Suite 2.1, DRGEM RADMAX | **[NEW v4.0]** GE, DRGEM | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-086 | **[NEW v4.0]** Philips Vue PACS 15, OHIF Viewer 오픈소스 | **[NEW v4.0]** Philips, OHIF | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-087 | **[NEW v4.0]** dicomPACS DX-R, ChiroSight | **[NEW v4.0]** OR Technology | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-088 | **[NEW v4.0]** Siemens Remote Service, Philips FutureProof20 | **[NEW v4.0]** Siemens, Philips | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-089 | **[NEW v4.0]** EU AI Act (Regulation 2024/1689), 2026.08 시행 | **[NEW v4.0]** EU 규제 | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-090 | **[NEW v4.0]** EU NIS2 Directive, MDR Article 87a | **[NEW v4.0]** EU 규제 | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-091 | **[NEW v4.0]** Shimadzu VISION SUPPORT, Fujifilm FDR Visionary | **[NEW v4.0]** Shimadzu, Fujifilm | **[NEW v4.0]** 있으면좋음 |
| **[NEW v4.0]** MR-092 | **[NEW v4.0]** Green Radiology Initiative, ECR 2025 | **[NEW v4.0]** ECR 2025 | **[NEW v4.0]** 있으면좋음 |

> **[NEW v4.0]** 상세 교차검증 결과: `docs/planning/CVR-002_MRD_PRD_CrossVerification_v1.0.md` 참조
...
### 부록 F: UISPEC 추적성 매트릭스 (UI Design Specification Traceability)

> 본 MRD에 정의된 요구사항을 구현하는 UI 디자인 명세서(UISPEC)와의 추적성을 제공합니다. UISPEC은 PPT 디자인 시안과 코드 구현 사이의 브릿지 역할을 하며, 3계층 문서 아키텍처의 Layer 2에 해당합니다.

#### F.1 UISPEC 문서 목록

| UISPEC ID | 문서 제목 | PPT 참조 | 구현 파일 | 상태 |
|----------|---------|---------|----------|------|
| **UISPEC-001** | 로그인 화면 UI 디자인 명세서 | Slide 1-3 | LoginView.xaml | 95% 준수 |
| **UISPEC-002** | 워크리스트 화면 UI 디자인 명세서 | Slide 2-4 | PatientListView.xaml | 44% 준수 |
| **UISPEC-003** | 스터디리스트 화면 UI 디자인 명세서 | Slide 5-7 | StudylistView.xaml | 63% 준수 |
| **UISPEC-004** | 촬영(Acquisition) 화면 UI 디자인 명세서 | Slide 9-11 | WorkflowView.xaml, ImageViewerView.xaml | 신규 생성 |
| **UISPEC-005** | 환자/시술 추가 화면 UI 디자인 명세서 | Slide 8 | AddPatientProcedureView.xaml | 신규 생성 |
| **UISPEC-006** | 영상 병합(Merge) 화면 UI 디자인 명세서 | Slide 12-13 | MergeView.xaml | 신규 생성 |
| **UISPEC-007** | 설정(Settings) 화면 UI 디자인 명세서 | Slide 14-22 | SettingsView.xaml, SystemAdminView.xaml | 신규 생성 |
| **UISPEC-008** | 이미지 뷰어(ImageViewer) UI 디자인 명세서 | (Acquisition 내장) | ImageViewerView.xaml | 신규 생성 |
| **UISPEC-009** | 시스템 관리(SystemAdmin) UI 디자인 명세서 | Slide 14-22 | SystemAdminView.xaml | 신규 생성 |

> **위치**: `docs/design/spec/` 폴더

#### F.2 MR 카테고리별 UISPEC 매핑

| MR 카테고리 | 관련 UISPEC | 주요 UI 요구사항 |
|-----------|-------------|----------------|
| **워크플로우 효율성** (5.1) | UISPEC-002, 003, 004, 006 | 워크리스트, 스터디리스트, 촬영 워크플로우, 병합 기능 |
| **영상 품질** (5.2) | UISPEC-008 | 이미지 뷰어, W/L 조정, 영상 도구 |
| **통합/연동성** (5.3) | UISPEC-002, 003, 004 | PACS 연동, DICOM 설정 UI |
| **안전성 및 선량 관리** (5.4) | UISPEC-004, 007 | 선량 표시, 노출 버튼, 안전 경고 UI |
| **사이버보안** (5.5) | UISPEC-007, 009 | 로그인, 사용자 관리, 감사 로그 |
| **UX/UI** (5.6) | **모든 UISPEC** | 전체 UI/UX 디자인 기준 |
| **규제 준수** (5.7) | UISPEC-004, 007, 009 | IEC 62366 준수, 안전 중요 UI |
| **확장성 및 AI-Readiness** (5.8) | UISPEC-007, 008 | 확장 가능한 아키텍처 UI |

#### F.3 Tier별 UISPEC 우선순위

| Tier | 대상 UISPEC | 우선순위 사유 |
|------|------------|--------------|
| **Tier 1** (인허가 필수) | UISPEC-001, 004, 007, 009 | 로그인/인증, 촬영 제어, 설정, 관리자 — 규제 필수 |
| **Tier 2** (시장 진입 필수) | UISPEC-002, 003, 008 | 워크리스트, 스터디리스트, 이미지 뷰어 — feel-DRCS 기본 기능 동등 |
| **Tier 3** (있으면 좋고) | UISPEC-005, 006 | 환자 추가, 병합 — 경쟁 차별화 |

#### F.4 3계층 문서 아키텍처

```
Layer 1: 비즈니스 요구사항
  ├─ MRD (본 문서): 72개 MR 항목, 4-Tier 우선순위
  └─ PRD (DOC-002): FR/NFR 요구사항

Layer 2: UI 디자인 명세 (UISPEC)
  └─ 9개 UISPEC-001~009: 화면별 디자인 명세
      ├─ PPT 디자인 시안 의도 정확히 문서화
      ├─ MRD/PRD 요구사항과 트레이서빌리티 연결
      ├─ 구현 우선순위 및 Gap 명시
      └─ WPF 토큰 매핑 포함

Layer 3: 구현 명세 및 코드
  ├─ SPEC (SPEC-UI-001): 구현 계획 및 작업 분해
  └─ Code (src/HnVue.UI/): WPF XAML/C# 구현
```

#### F.5 UISPEC 활용 가이드

1. **개발자**: UISPEC을 참조하여 PPT 디자인 의도를 정확히 구현
2. **디자이너**: UISPEC을 통해 UI 결정의 MRD/PRD 근거 확인
3. **QA/검증자**: UISPEC의 갭 분석 섹션으로 검증 체크리스트 활용
4. **규제 담당자**: IEC 62366 사용성 공학 문서로 활용
