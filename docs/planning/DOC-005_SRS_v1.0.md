...
| **상위 문서** | PRD-XRAY-GUI-001 v3.0, FRS-XRAY-GUI-001 v1.0 |
...
| 촬영 워크플로우 (Acquisition Workflow) | SWR-WF | WF-010~031 | 대부분 Safety-related |
...
| 사이버보안 (Cybersecurity) | SWR-CS | CS-070~085 | Security-related |
...
| 문서 ID | 문서명 | 버전 | 역할 |
|---------|--------|------|------|
| PRD-XRAY-GUI-001 | 제품 요구사항 문서 (Product Requirements Document) | v3.0 | 상위 Design Input (PR-xxx) |
| FRS-XRAY-GUI-001 | 기능 요구사항 명세서 (Functional Requirements Specification) | v1.0 | 원본 SWR 정의 문서 |
...
| SWR-NF-RG-060 | Functional | IEC 62304 산출물 완비 | DHF에 SDP, SRS, SAD, SDS, UT/IT/ST 결과, V&V 보고서, 릴리스 보고서, 형상 관리 기록 포함 | PR-NF-RG-060 | — | I, A |
...
| SWR-NF-RG-060 | Functional | IEC 62304 산출물 문서 완비 | SDP, SRS, SAD, SDS, 테스트 보고서, 릴리스 보고서 DHF 포함 | PR-NF-RG-060 | — | I, A |
...
|--------|---------------|-----------|------|---------|---------|---------|
| SWR-NF-RG-060 | Functional | IEC 62304 Class B 산출물 완비 | IEC 62304 전체 산출물 DHF 포함. 갭 분석 결과 0 Gap | PR-NF-RG-060 | IEC 62304 | I, A |
...
> 본 부록은 FRS-XRAY-GUI-001 v1.0의 모든 SWR을 IEC 62304 §5.2 분류에 매핑하는 마스터 테이블을 제공한다.
...
*본 문서는 SRS-XRAY-GUI-001 v1.0이며, IEC 62304:2006+A1:2015 §5.2 **소프트웨어 요구사항 명세서**로서 FRS-XRAY-GUI-001 v1.0의 소프트웨어 요구사항을 IEC 62304 §5.2 규격 구조에 맞게 재편성한 문서입니다.*

*모든 SWR-xxx 요구사항은 PRD-XRAY-GUI-001 v3.0의 PR-xxx(시스템 수준 Design Input)로부터 도출되었으며, FDA 21 CFR 820.30(d) Design Output으로 기능합니다.*
