...
본 가이드는 HnVue의 공인기관(KTL 등) 사이버보안 시험 의뢰 전에, 내부에서 **무료 또는 최소 비용**으로 자체 사전평가를 수행하여 시험 불합격 리스크를 최소화하는 것을 목적으로 한다.
...
*본 문서는 HnVue 프로젝트의 내부 사용을 위해 작성되었습니다.*  
