...
**비용**: 내부 독립 인력 수행 시 무료, 외부 위탁 시 $5,000~$15,000
...
| 방식 | 예상 비용 | 소요 기간 | FDA 수용성 | EU MDR 수용성 | MFDS 수용성 |
|------|-----------|-----------|------------|---------------|-------------|
| **완전 자체** (독립 내부 인력, OSCP) | $0~$3,000 (인력 시간) | 2~4주 | ✅ 독립성+자격증 증빙 시 | ✅ | ✅ |
| **하이브리드** (자체 SAST/SCA + 외부 침투) | $5,000~$15,000 | 3~6주 | ✅ 권장 방식 | ✅ | ✅ |
| **완전 외부** (전문 의료기기 보안 업체) | $15,000~$50,000 | 4~8주 | ✅ 가장 안전한 방식 | ✅ | ✅ |
| **외부 없이 자체만** (개발팀 직접) | $0 | 1~2주 | ❌ FDA 거부 가능 | ❌ | ❌ |

> **권장**: 자체 SAST+SCA+네트워크스캔+DICOM 퍼징 수행 후, 침투 테스트만 독립 내부 인력(OSCP/CEH) 또는 소규모 외부 전문가 위탁. 총 비용 $5,000~$15,000으로 인허가 요건 충족 가능.
